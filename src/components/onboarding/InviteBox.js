    ...
    return (
        <div className='radius-8 border-green border-1 p-3 desktop-flex align-items-center space-between bg-dark1'>
            <div className='color-white d-flex align-items-center font-18 bold-500'>
                <div className='mr-10 px-3 py-2 bg-gray1 radius-8 color-green number_box'>2</div><div>Add Referral Wallet Address</div>
            </div>
            <div className='my-2'>
                <AsyncButton className='gloop-btn-primary font-16 bold-700 radius-8 bg-green border-green color-dark p-10 min-w-200' onClick={openModal} disabledreason={openModalButtonDisabledReason}>Add</AsyncButton>
            </div>
            <Modal show={show} onHide={closeModal} centered className='buy_gloop_modal'>
                <Modal.Body className='px-3 radius-8 bg-trans1 border-dark w-100' style={{ height: '200px' }}>
                    <div ><img src={close_img_url} width={10} className='invite_modal_close' onClick={closeModal} /></div>

                    <div className='d-flex flex-column space-between h-100'>
                        <div className='font-18 bold-500 color-white text-center'>Enter Referral Wallet Address</div>
