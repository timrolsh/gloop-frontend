    ...
    <div>
      <div className="border-dash radius-8 p-3 mt-2">
        ...
        <div className="font-14 bold-300 color-white mt-2">
          Redeem GDC to get IOU’s. These IOU’s will be automatically staked in the Stability Pool to
          benefit from liquidations and Gloop token rewards. IOU’s can also be used to repay your
          debt.
        </div>
      </div>
