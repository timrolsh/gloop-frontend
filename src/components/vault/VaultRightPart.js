    ...
    <div className="radius-8 bg-trans p-4">
      ...
      <div className="border-dash radius-8 p-3 mt-4">
        ...
        <div className="font-14 bold-300 color-white">
          As you earn yield on Gloop, most of it is taken and used to increase your collateral to
          constantly leverage you down.  This allows our users to constantly feel safer as they
          allow their wealth to grow.
        </div>
      </div>
      <div className="d-flex v-center space-between mt-3">
        ...
        <div className="text-end">
          <div className="font-16 bold-700 color-white my-3">0 ETH</div>
          <div className="font-16 bold-700 color-white my-3">0 IOU</div>
      ...
      <div className="d-flex v-center space-between mt-3">
        ...
        <div className="text-end">
          <div className="font-16 bold-700 color-white my-3">0 [Token]</div>
        </div>
      </div>
      <div className="desktop-flex space-between">
        ...
        <div className="width-100 p-1">
          <Button
            className="gloop-btn-second font-16 bold-700 radius-8 bg-trans-0 border-white color-white p-10-25 my-2 w-100"
            onClick={openModal1}
          >
            Supply
          </Button>
        ...
        <Modal.Body className="p-4 radius-8 bg-trans1 border-dark w-100">
          ...
          <div className="radius-8 border-2 border-dark-green p-3 mt-4">
            ...
            <div className={`d-flex v-center space-between mt-2 ${!detailShow ? "d-none" : ""}`}>
              ...
              <div className="text-end">
                <div className="font-16 bold-700 color-white my-2">15,000 IOU</div>
                <div className="font-16 bold-700 color-white my-2">5,000 IOU</div>
              </div>
            </div>
          </div>
          ...
          <div className="desktop-flex space-between">
            <div className="width-100 p-1">
              <Button className="gloop-btn-second font-16 bold-700 radius-8 bg-trans-0 border-white color-white p-10-25 my-2 w-100 ">
                Get IOU
              </Button>
            </div>
            <div className="width-100 p-1">
        ...
        <Modal.Body className="p-4 radius-8 bg-trans1 border-dark w-100">
          ...
          <div className="radius-8 border-2 border-dark-green p-3 mt-4">
            ...
            <div className={`d-flex v-center space-between mt-2 ${!detailShow1 ? "d-none" : ""}`}>
              ...
              <div className="text-end">
                <div className="font-16 bold-700 color-white my-2">0 GLP</div>
                <div className="font-16 bold-700 color-white my-2">$0,00</div>
          ...
          <div className="radius-8 bg-trans p-3 mt-3 desktop-flex space-between v-center">
            <div className="d-flex v-center my-1">
              <img src={modal_img1_url} width={29} className="mr-10" />
              <span className="font-18 bold-700 color-white mr-10">0</span>
              <span className="font-18 bold-400 color-gray mr-10">GLP</span>
            </div>
          ...
          <div className="d-flex v-center space-between mt-3">
            ...
            <div className="text-end">
              <div className="font-16 bold-700 color-white my-2">$ 1,116.50</div>
              <div className="font-16 bold-700 color-white my-2">0 GLP</div>
            </div>
          </div>
          <div className="mt-2">
