    ...
    <div className="radius-8 bg-trans p-4">
      ...
      <div className="border-dash radius-8 p-3 mt-4">
        ...
        <div className="font-14 bold-300 color-white">
          The IOU token has a value of $1 of debt within the system and can't be traded outside
          Gloop. You can use it to mint our stablecoin (GDC) or you can deposit it a stability pool
          to get liquidation benefits.
        </div>
      </div>
      <div className="font-14 bold-300 color-gray mt-4">ETH Deposit</div>
      <div className="radius-8 bg-trans p-3 mt-3 desktop-flex space-between v-center">
        <div className="w-25-100 d-flex v-center my-1">
          <img src={props.asset_url} width={29} className="mr-10 rounded-circle" />
          <span className="font-18 bold-700 color-white mr-10">20</span>
      ...
      <div className="font-14 bold-300 color-gray mt-4">Borrowed Amount (1 IOU = $1)</div>
      <div className="radius-8 bg-trans p-3 mt-3 desktop-flex space-between v-center">
        <div className="d-flex v-center my-1">
          <img src={vault_img9_url} width={29} className="mr-10" />
          <span className="font-18 bold-700 color-white mr-10">20,000</span>
          <span className="font-18 bold-400 color-gray mr-10">IOU</span>
        </div>
      ...
      <div className="d-flex v-center space-between mt-3">
        ...
        <div className="text-end">
          <div className="font-16 bold-700 color-white my-3">200 IOU</div>
          <div className="font-16 bold-700 color-white my-3">
            100 IOU <span className="font-12 bold-400 color-gray">(0.50%)</span>
          </div>
          <div className="font-16 bold-700 color-white my-3">20,300.00 IOU</div>
          <div className="font-16 bold-700 color-white my-3">$ 1,116.50</div>
        </div>
      </div>
      <div className="mt-2">
        <Button
      ...
      <Modal show={show} onHide={closeModal} centered className="buy_gloop_modal">
        <Modal.Body className="p-4 radius-8 bg-trans1 border-dark w-100">
          <div className="d-flex v-center space-between">
            ...
            <div className="font-16 bold-700 color-white radius-8 bg-trans desktop-show p-2">
              <span className="bold-400 color-gray">Balance →</span> 50,000 IOU
            </div>
          </div>
          <div>
            <hr className="hr-3 border-dark-green" />
          ...
          <div className="radius-8 border-2 border-dark-green p-3 mt-4">
            ...
            <div className={`d-flex v-center space-between mt-2 ${!detailShow ? "d-none" : ""}`}>
              ...
              <div className="text-end">
                <div className="font-16 bold-700 color-white my-2">X %</div>
                <div className="font-16 bold-700 color-white my-2">X %</div>
              </div>
            </div>
          </div>
          <div className="font-14 bold-400 color-gray mt-4 mb-2">IOU Deposit</div>
          <div>{replace ? <FromVault /> : <ToVault />}</div>
          ...
          <div>{replace ? <ToVault /> : <FromVault />}</div>
          <div className="d-flex v-center space-between mt-3">
            <div>
              <div className="font-16 bold-300 color-gray my-2 ">
            ...
            <div className="text-end">
              <div className="font-16 bold-700 color-white my-2">$1.00</div>
              <div className="font-16 bold-700 color-white my-2">100%</div>
              <div className="font-16 bold-700 color-white my-2">
                0 <span className="bold-400 color-gray">($0)</span>
              </div>
              <div className="font-16 bold-700 color-white my-2">0 IOU</div>
              <div className="font-16 bold-700 color-white my-2">0 %</div>
            </div>
          </div>
          <div className="mt-2">
