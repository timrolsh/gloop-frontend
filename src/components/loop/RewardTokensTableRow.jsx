...
const RewardTokensTableRow = ({ tokenAddress, totalUnclaimedReward }) => {
  ...
  const oraclePriceFeedQuery = useGetOraclePriceFeed({ tokenAddress: OraclePriceFeedAddressMapper[tokenAddress], enabled: tokenAddress !== "0x1b9a9f26e553b10AC0d410f67A86A767a35CF162" }) // if token is not Gloop
  const gloopPriceQuery = useGetGloopPrice({ enabled: tokenAddress === "0x1b9a9f26e553b10AC0d410f67A86A767a35CF162" }) // // if token is Gloop

  const unclaimedValue = useMemo(() => {

    const price = tokenAddress === "0x1b9a9f26e553b10AC0d410f67A86A767a35CF162" ? gloopPriceQuery.data : oraclePriceFeedQuery.data
