  ...
  return (
    <div className="market-loop">
      <div className="mt-2 loop-info">
        ...
        <div className="mt-2">
          Boost your yield by leveraging up to 10x. This feature automates the deposit and borrowing
          cycles until your targeted APY is reached.
        </div>
      </div>
      <div className="mt-4">
        <div className="loop-input-title mb-2">Market</div>
      </div>
      <div className="mt-4">
        <div className="loop-input-title">
          <span>Deposit</span>
          <span className="link-title">
            Get {depositAsset.name}
        ...
        >
          <div className="w-25-100 d-flex v-center my-1">
            <img src={depositAsset.image} width={29} className="mr-10" />
            <span className="font-18 bold-700 color-white mr-10">0</span>
            <span className="font-18 bold-400 color-gray mr-10"> {depositAsset.name}</span>
          </div>
      ...
      <div className="mt-4">
        ...
        <WheelRange
          ...
          maxValue={10}
          initialValue={5}
          onChange={(val) => setLeverageValue(val)}
        />
      </div>
      ...
      <Button className="loop-btn-second mt-4 font-16 bold-700 radius-8 text-black p-10-25 my-1 w-100">
        Loop It!
      </Button>
    </div>
  );
