    ...
    <div className="radius-8 bg-trans p-4 min-h-500">
      ...
      <div className="d-flex v-center space-between">
        ...
        <div className="text-end">
          <div className="font-16 bold-700 color-white my-3">$0.012</div>
          <div className="font-16 bold-700 color-white my-3">$0</div>
          <div className="font-16 bold-700 color-white my-3">$1,800,000</div>
        </div>
      </div>
      <div>
      ...
      <div className="d-flex v-center space-between">
        ...
        <div>
          <div className="font-16 bold-700 color-white my-3">$5,400,000</div>
          <div className="font-16 bold-700 color-white my-3">$12,000,000</div>
        </div>
      </div>
      <div className="mt-3">
        <Button className="gloop-btn-second font-16 bold-700 radius-8 bg-trans-0 border-white color-white p-10-25 my-2 w-100 ">
          Private Sale Start in 7d 02h 12m 50s
        </Button>
      </div>
    </div>
  );
