    ...
    <div className="radius-8 bg-trans p-4 min-h-500">
      ...
      <div className="d-flex v-center space-between">
        ...
        <div className="text-end">
          <div className="font-16 bold-700 color-white my-3">1</div>
          <div className="font-16 bold-700 color-white my-3">10</div>
          <div className="font-16 bold-700 color-white my-3">0</div>
          <div className="font-16 bold-700 color-white my-3">60,000 USDC</div>
        </div>
      </div>
      <div>
      ...
      <div className="d-flex v-center space-between">
        ...
        <div>
          <div className="font-16 bold-700 color-white my-3">5,000 USDC</div>
          <div className="font-16 bold-700 color-white my-3">416,666.667</div>
        </div>
      </div>
      <div className="desktop-flex space-between">
        ...
        <div className="width-100 p-1">
          <Button className="font-16 bold-700 radius-8 bg-trans-0 border-white color-white p-10-25 my-2 w-100 opacity-20">
            Claim
          </Button>
        </div>
      </div>
        ...
        <Modal.Body className="p-4 radius-8 bg-trans1 border-dark w-100">
          ...
          <div className="radius-8 bg-trans p-3 mt-2 desktop-flex space-between v-center">
            <div className="w-25-100 d-flex v-center my-1">
              <img src={gloop_img5_url} width={29} className="mr-10" />
              <span className="font-18 bold-700 color-white mr-10">0</span>
              <span className="font-18 bold-400 color-gray mr-10"> USDC</span>
          ...
          <div className="d-flex v-center space-between">
            ...
            <div className="text-end">
              <div className="font-16 bold-700 color-white my-3">0 GLOOP</div>
            </div>
          </div>
          <div className="mt-2">
