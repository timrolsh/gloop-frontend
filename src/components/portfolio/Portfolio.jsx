    ...
    <>
      <div className='my-4 position-information-card loop-info bg-trans'>
        <div className='title'>
          ...
          Health Factor</div>
        <div className='mt-2'>If your health factor goes below 100%, a portion or all of your collateral could be seized by other users in a liquidation. To avoid this, supply more collateral or repay some or all of your borrow position.</div>
      </div>
