      ...
      <Modal.Body className='p-4 radius-8 bg-trans1 border-dark w-100'>
        ...
        <div className='mt-4 mb-4 loop-info'>
          <div className='title'>
            ...
            Deposit</div>
          <div className='mt-2'>Deposit collateral to borrow USDC. Make sure your Health Factor remains above 100%.</div>
        </div>
        ...
        <div className='radius-8 border-2 border-dark-green p-3 mt-4'>
          ...
          <div className={`d-flex v-center space-between mt-2 ${!withdrawDetaiVisible ? "d-none" : ""}`}>
            ...
            <div className='text-end'>
              <div className='font-16 bold-700 color-green my-2'>
                Enabled
              </div>
            </div>
          </div>
        ...
        <div className='mt-2'>
          <AsyncButton onClick={handleDeposit} loading={buttonLoading} disabledreason={buttonDisabledReason} className='mt-4'>Deposit</AsyncButton>
        </div>
      </Modal.Body>
    </Modal>
  )
