        ...
        <div>
                        ...
                        <Col sm={9} className='w-75-100'>
                            <div className='desktop-flex v-center'>
                                ...
                                <div className='color-white font-16 my-2'>
                                    Earn points for participating in Gloop's growing ecosystem by referring friends, lending USDC, and borrowing USDC. Current Rates and Boosts: Lending USDC: 2 points per dollar per day, Borrowing USDC: 1 point per dollar per day. Referral Boost: XX% each, with a max of XX referrals.
                                </div>
                            </div>
                        </Col>
            ...
            <section>
                ...
                <Container className='mt-3 mb-2'>
                    ...
                    <Row className='overflow-hidden v-center'>
                        ...
                        <Col sm={6} className='' >
                            <Skeleton loading={leaderboardQuery.isLoading || !leaderboardQuery.data?.totalPoints} height='100px'>
                                <div className='bg-trans1 radius-8 p-3 my-2'>
                                    <div className='d-flex space-between v-center'>
                                        <div className='p-2'>
                                    ...
                                    <div className='font-20 bold-700 color-white px-2 pb-2'>{truncateAmount(leaderboardQuery?.data?.totalPoints)}</div>
                                </div>
                            </Skeleton>
                        </Col>
                    </Row>
            ...
            <section>
                <Container>
                    <Row className='mt-3'>
                        <Col sm={12}>
                            <LeaderboardTable rankings={leaderboardQuery?.data?.LeaderboardList || []} isPlaceholderData={leaderboardQuery.isPlaceholderData} isError={leaderboardQuery.isError} isLoading={leaderboardQuery.isLoading} />
                        </Col>
                    </Row>
                </Container>
            </section>
