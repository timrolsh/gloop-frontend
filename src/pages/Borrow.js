            ...
            <Col sm={9} className="w-75-100">
              <div className="desktop-flex v-center">
                ...
                <div className="color-white font-16 my-3">
                  ...
                  more GM tokens and loop the process to gain additional GMX-native APY.
                </div>
              </div>
            </Col>
            ...
            <Col className="mx-auto" sm={9} xs={12}>
              <Row>
                <Col sm={6} className="w-50-100 p-0">
                  <div
                    className={`bg-transparent border-3-bottom loop_tab_item ${
                      activeTab === "market" ? "loop_tab_item_active" : ""
                    }`}
                ...
                <Col sm={6} className="w-50-100 p-0">
                  <div
                    className={`bg-transparent border-3-bottom  loop_tab_item ${
                      activeTab === "portfolio" ? "loop_tab_item_active" : ""
                    }`}
