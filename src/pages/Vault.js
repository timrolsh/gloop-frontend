                ...
                <Container className='my-5'>
                    ...
                    <Row >
                        <Col sm={4} className='w-33-100' >
                            <div className={`bg-trans1 radius-8 p-3 my-2 border-1 vault_asset_item ${activeAsset == "eth" ? "vault_asset_item_active": ""}`} onClick={()=>setSelectedAsset(vault_img1_url)}>
                        ...
                        <Col sm={4} className='w-33-100' >
                            <div className={`bg-trans1 radius-8 p-3 my-2 border-1 vault_asset_item ${activeAsset == "glp" ? "vault_asset_item_active": ""}`} onClick={()=>setSelectedAsset(vault_img2_url)}>
                                <div className='d-flex space-between v-center'>
                                    <div className='p-2 text-center'>
                        ...
                        <Col sm={4} className='w-33-100' >
                            <div className={`bg-trans1 radius-8 p-3 my-2 border-1 vault_asset_item ${activeAsset == "gmx" ? "vault_asset_item_active": ""}`} onClick={()=>setSelectedAsset(vault_img3_url)}>
                                <div className='d-flex space-between v-center'>
                                    <div className='p-2 text-center'>
                        ...
                        <Col sm={12}>
                            <div className='d-flex v-center mb-3 space-between'>
                                ...
                                <div className='mobile-left'>
                                    <a href="#" target='_blank' className='gloop-btn-second btn font-16 bold-700 radius-8 bg-trans-0 border-white color-white p-10-25'><span className='mr-10'>Buy wstETH</span><img src={gmi_img2_url} width={12}/></a>
                                </div>
                            </div>
                        </Col>
                    </Row>
