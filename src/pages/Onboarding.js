          ...
          <Row>
            ...
            <Col sm={8}>
              <div className="text-center mb-4">
                <div className="font-52 color-white bold-600">
                  Want to join the <span className="color-green">Gloopers?</span>
                </div>
                <div className="font-16 color-white bold-400 mt-3">
                  Begin your farming journey by completing the quests below.
                </div>
              </div>
              <div className="my-3">
                <WalletBox />
