                    ...
                    <Row className='radius-8 bg-trans m-0 py-4 px-3'>
                        ...
                        <Col sm={3}  className='w-25-100'>
                            <div className='mobile-left my-3'>
                                <a href="#" target='_blank' className='gloop-btn-second btn font-16 bold-400 radius-8 bg-trans-0 border-white color-white p-10-25 my-2'><span className='mr-10'>Buy GDC</span><img src={gmi_img2_url} width={12}/></a>
                            </div>
                        </Col>
                    </Row>
                </Container>
